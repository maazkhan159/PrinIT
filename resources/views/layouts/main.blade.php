...
<div class="main-agile">
  ...
  <div class="container-fluid" style="background-color: #2c3e58; border-color: #2c3e58; border-radius: 0px;">
          
    <ul class="nav navbar-nav navbar-right" >
        @if(Auth::check())
      <li><a href="{{ url('/logout') }}" style="color:white;"><span class="fa fa-sign-out"></span> Log Out</a></li>
            @endif
      @if(!Auth::check())
        <li><a href="{{ url('/login') }}" style="color: white;"><span class="fa fa-lock" ></span> Login</a></li>
      <li><a href="{{ url('/register') }}" style="color: white;"><span class="fa fa-user-plus"></span> Sign Up</a></li>
...
<nav class="navbar navbar-inverse" style="border-radius: 0px; border-color: #e7e7e7; background-color: #e7e7e7; padding: 10px 0; min-height: 70px; width: 100%; margin: 0px;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" style="font-weight: 700;color:#f77924 !important;font-size: 30px;line-height: 20px;font-style: normal;text-transform: uppercase;">Easy Label Printing</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
         
        <li style="font-size: 15px;font-weight: 600; text-transform: uppercase;font-family: "Raleway", sans-serif; "><a href="{{ url('/user_dashboard') }}" class="scroll active">HOME</a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="{{URL::to ('assets/images/1.jpg')}}" alt="Los Angeles" width="100%" height="100%">
      ...
      <div class="item">
        <img src="{{URL::to ('assets/images/1.jpg')}}" alt="Chicago" width="100%" height="100%" >
        <!-- <div class="carousel-caption">
          <h3>Chicago</h3>
      ...
      <div class="item">
        <img src="{{URL::to ('assets/images/1.jpg')}}" alt="New York" width="100%" height="100%" >
        <!-- <div class="carousel-caption">
          <h3>New York</h3>
