                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-themeprimary">
                                ...
                                <span class="widget-caption themeprimary">Upload Amazon Csv File</span>
                            </div><!--Widget Header-->
                            <div class="widget-body no-padding">
                                <div class="task-container padding-20 whitebg">
                                    ...
                                    <form method="POST" action="{{ url('/parsing') }}" accept-charset="utf-8" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small id="fileHelp" class="form-text text-muted">Upload your Amazon csv file</small>
                                                </div>
                                            </div>
                                        ...
                                        <a href="{{ url('/amazoncsv_sample_download') }}" class="btn btn-primary">Download Amazon Csv sample</a>
                                    </form>
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">Amazon Csv File Details</span>
